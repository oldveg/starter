...
$config['collections']['groups']         = 'niveis_permissao';
...
$config['tables']['groups']          = 'niveis_permissao';
$config['tables']['users_groups']    = 'usuarios_has_niveis_permissao';
$config['tables']['login_attempts']  = 'login_attempts';
/* Tabelas de validação de permissoes */
$config['tables']['sys_permissoes']  = 'sys_permissoes';
$config['tables']['sys_metodos']	 = 'sys_metodos';
/* ---------------------------------- */
 ...
 */
$config['join']['users']  = 'usuarios_id';
$config['join']['groups'] = 'niveis_permissao_cod_nivel_permissao';
 ...
 */
$config['site_title']           = "VEG Tecnologia"; 		// Site Title, example.com
$config['admin_email']          = "admin@vegtecnologia.com.br"; 	// Admin Email, admin@example.com
